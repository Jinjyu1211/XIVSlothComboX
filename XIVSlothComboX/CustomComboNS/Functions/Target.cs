...
namespace XIVSlothComboX.CustomComboNS.Functions
{
    internal abstract partial class CustomComboFunctions
    {
        ...
        public static bool HasFriendlyTarget(IGameObject? OurTarget = null)
        {
            ...
            //Humans and Trusts
            if ((int)OurTarget.ObjectKind == 1)
                return true;

            //AI
            if (OurTarget is IBattleNpc) return (int)(OurTarget as IBattleNpc).BattleNpcKind != 2 && (int)(OurTarget as IBattleNpc).BattleNpcKind != 1;
